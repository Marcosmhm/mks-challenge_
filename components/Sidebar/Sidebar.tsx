  ...
  return (
    ...
    >
      <div className={styles.cartFlex}>
        <h3 className={styles.cartTitle}>Commit para testar branch e pull request 2</h3>
          ...
          <div className={styles.productWrapper} key={`${product.id} ${index}`}>
            <div className={styles.productContainer}>
              ...
              <div className={styles.ammountContainer}>
                <span
                  className={styles.ammountButton}
                  onClick={() => handleDecrementItem(product)}
                >
                  -
                </span>
                <span className={styles.ammountPreview}>
                  {product.quantity}
                </span>
                <span
                  className={styles.ammountButton}
                  onClick={() => hanldeIncrementItem(product)}
                >
                  +
                </span>
              </div>
